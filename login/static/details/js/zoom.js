...
function imageZoom(imgID){
	...
	function moveLens(){
		...
		*/
		...
		if(positionLeft > img.width - lens.offsetWidth / 1.04){
			positionLeft = img.width - lens.offsetWidth / 1.04
		}

		if(positionTop > img.height - lens.offsetHeight / 1.04){
			positionTop = img.height - lens.offsetHeight / 1.04
		}
